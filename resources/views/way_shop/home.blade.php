@extends('way_shop.layouts.master')
            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="shop-cat-box">
                        <img class="img-fluid" src="{{ asset('frontend/images/t-shirts-img.jpg') }}" alt="" />
                        <a class="btn hvr-hover" href="#">T-shirts</a>
                    </div>
                    <div class="shop-cat-box">
                        <img class="img-fluid" src="{{ asset('frontend/images/shirt-img.jpg') }}" alt="" />
